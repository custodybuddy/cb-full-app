...
/**
 * Sanitizes HTML to remove unsafe tags/attributes before rendering.
 */
...
/**
 * Convenience helper to sanitize the output of formatMarkdown/linkify pipelines.
 */
export const sanitizeMarkdownHtml = (html: string): string => sanitizeHtml(html);
