...
const IncidentHeaderBadges: React.FC<IncidentHeaderBadgesProps> = ({
    ...
    <div className="not-prose text-center md:text-left">
        <h1 className="text-3xl font-black text-gray-100 mb-3">{title}</h1>
        <div className="flex flex-wrap gap-2 text-xs text-gray-200 justify-center md:justify-start">
        ...
        <p className={`mt-2 text-sm italic p-2 rounded-md text-center md:text-left ${severityClass}`}>{severityJustification}</p>
    </div>
);
