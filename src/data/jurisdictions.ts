...
export const JURISDICTIONS: JurisdictionMetadata[] = [
    ...
    // ----------------------------
    {
        ...
        country: 'CA',
        region: 'Alberta',
        notes: 'Family cases heard in Court of Justice (for parenting/support) and Court of King\'s Bench (for divorce/property). No unified family court.',
    ...
    },
    {
        ...
        notes: 'Provincial Court handles most parenting/support; Supreme Court handles divorce/property. No unified family court.',
        hasUnifiedFamilyCourt: false,
    },
    {
        id: 'manitoba',
    ...
    },
    {
        ...
        notes: 'Provincial Court handles child protection; Court of King\'s Bench handles divorce, parenting, and support. Unified in some areas.',
        hasUnifiedFamilyCourt: true,
    },
    {
    ...
    },
    {
        ...
        notes: 'Supreme Court handles divorce/property; Territorial Court handles support/parenting for unmarried parents.',
        hasUnifiedFamilyCourt: false,
    },
    {
        id: 'nova scotia',
    ...
    },
    {
        ...
        country: 'CA',
        region: 'Ontario',
        notes: 'Three-court system: Ontario Court of Justice, Superior Court of Justice, and Unified Family Court (SCJ-FC). Divorce & property only in Superior.',
        hasUnifiedFamilyCourt: true,
    },
    {
    ...
    ...[
        ...
        usesUCCJEA: true,
        notes: 'State-level family court system. Uses UCCJEA for custody jurisdiction based on home-state rule (last 6 months).',
    })),
];
